...
<head>
	...
	<title>TDC-GP2 TDC for Ultrasonic Flow Meters and Ultrasonic Heat Meters</title>

	<meta http-equiv="Content-type" content="text/html; charset=iso-8859-1" />
	<meta name="keywords" content="precision measurement technologies, time to digital tech" />
	<meta name="description" content="TDC-GP2 TDC for Ultrasonic Flow Meters, Ultrasonic Heat Meters, high resolution measurement systems from Precision Measurement Technologies." />	
...
<?php include("../includes/subnav-tdc.php"); ?>
		...
		<div id="subBody">
			<div id="subTop">
				<h1 class="sub">GP2 - The General Purpose TDC</h1>
			...
			<h2 class="sub">General Circuit Features</h2>
				...
				<ul class="sub">
					...
					<li>Typical current consumption 5 &micro;A</li>
				</ul>
