...
<head>
	...
	<title>Acam USA is now Precision Measurement Technologies</title>

	<meta http-equiv="refresh" content="6; url=http://www.pmt-fl.com">
	<meta http-equiv="Content-type" content="text/html; charset=iso-8859-1" />
	<meta name="keywords" content="precision measurement technologies, time to digital tech, acam usa" />
...
<?php include("../includes/subnav-tdc.php"); ?>
		...
		<div id="subBody">
			<div id="subTop">
				<h1 class="sub">Acam USA is now PMT!</h1>
				<img class="main" src="/images/gen/acam-pmt2.jpg" alt="Acam Time-to-Digital Converter" />
