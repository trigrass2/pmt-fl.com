...
<head>
  <title>AS5000-MA8H-1 Magnet - Magnetic Position Sensors | PMT</title>
 <meta name="description" content="The AS5000-MA8H-1 magnet is an NdFeB sintered magnet.">
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">AS5000-MA8H-1 Magnet</h1>
