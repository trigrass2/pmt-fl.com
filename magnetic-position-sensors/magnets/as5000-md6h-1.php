...
<head>
  <title>AS5000-MD6H-1 Magnet - Magnetic Position Sensors - PMT</title>
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">AS5000-MD6H-1 Magnet</h1>
        <h2 class="secondary-heading">Magnet for rotary position sensor</h2>

        <p class="intro">
        Diametric Magnet, D6x2.5mm, Arnold Magnetics</p>
        <p><img src="../../images/magnetic-position-sensors/AS5000-MD6H_f380greyscale.jpg" alt="AS5000-MD6H-1 Magnet for rotary position sensor" />
        </p>
