  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">AS5162 Rotary Position Sensor</h1>
        <h2 class="secondary-heading">12-bit rotary position sensor with linear analog output and overvoltage protection</h2>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS5162 Product Facts</h2></th>
          </tr>
          <tr>
            <td>Resolution</td>
            <td>12-bit</td>
