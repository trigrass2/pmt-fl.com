...
<head>
  <title>AS5045B Rotary Position Sensor - Magnetic Position Sensors | PMT</title>
   <meta name="description" content="Precision Measurement Technologies sells the AS5045B which is a contactless magnetic position sensor for accurate angular measurement over a full turn of 360 degrees."> 
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">AS5045B Rotary Position Sensor</h1>
        <h2 class="secondary-heading">12-bit rotary position sensor with digital angle (interface) and PWM and ABI output</h2>
        ...
        The AS5045B is a 12-bit rotary position sensor (previously known as encoder) for absolute angular measurement and with an incremental output over a full turn of 360&deg; based on contactless magnetic sensor technology. This device fits perfectly for on-axis applications where a simple 2-pole magnet rotates above or below the sensor IC and the zero position can be programmed into the device. The absolute magnet angular position is measured with a resolution of 12 bit = 4096 positions per revolution and it is provided as a digital value on the serial interface (SSI) and on the PWM output signal. 
          <img src="../../images/magnetic-position-sensors/AS5045B-Block-diagram_f380greyscale.png" alt="AS5045B Rotary Sensor Block Diagram"/>
        </p>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS5045B Product Facts</h2></th>
          </tr>
          <tr>
            <td>Resolution</td>
            <td>12-bit</td>
