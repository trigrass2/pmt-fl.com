...
<head>
  <title>AS5145A Rotary Position Sensor - Magnetic Position Sensors | PMT</title>
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">AS5145A Rotary Position Sensor</h1>
        ...
        The AS5145A is a contactless magnetic rotary position sensor for accurate angular measurement over a full turn of 360&deg; and over an extended ambient temperature range of -40&deg;C to 150&deg;C. The absolute angle measurement provides instant indication of the magnet&rsquo;s angular position with a resolution of 0.0879&deg; = 4096 positions per revolution via a serial bit stream and as a PWM signal. The incremental output (=ABI-interface) is preprogrammed for 10 bit = 1024 positions.
          <img src="../../images/magnetic-position-sensors/AS5145A-Automotive-Rotary-Position-Sensor-Block-Diagram_f380greyscale.jpg" alt="AS5145A contactless magnetic rotary position sensor block diagram"/>
        </p>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS5145A Product Facts</h2></th>
          </tr>
          <tr>
            <td>Resolution</td>
            <td>12-bit</td>
