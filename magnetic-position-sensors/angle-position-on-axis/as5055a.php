...
<head>
  <title>AS5055A Rotary Position Sensor - Magnetic Position Sensors</title>
  <meta name="description" content="The AS5055A is a single-chip on-axis magnetic rotary position sensor with low voltage and low power features. It includes an integrated Hall element array, a high resolution ADC and a smart power management controller."> 
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">AS5055A Rotary Position Sensor</h1>
        <h2 class="secondary-heading">12-bit magnetic position sensor with digital angle (interface) output</h2>

        <p class="intro">
        The AS5055A is a new version of the AS5055. It is a 12-bit rotary position sensor (previously known as encoder) for absolute angular measurement over a full turn of 360&deg; based on contactless magnetic sensor technology. This device fits perfectly for on-axis applications where a simple 2-pole magnet rotates above or below the sensor IC. The absolute magnet angular position is measured with a resolution of 12 bit = 4096 positions per revolution and it is provided as a digital value on the serial interface (SPI).
          <img src="../../images/magnetic-position-sensors/AS5055A_Rotary-Magnetic-Position-Sensor_Block-Diagram_f380greyscale.png" alt="AS5055A 12-bit magnetic position sensor with digital angle output"/>
        </p>
        <a href="../../downloads/magnetic-position-sensors/AS5055A_Datasheet_EN_v6.pdf"><button>Download Datasheet</button></a>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS5055A Product Facts</h2></th>
          </tr>
          <tr>
            <td>Resolution</td>
            <td>12-bit</td>
        ...
        <ul class="sub">
          ...
          <li>Rotary knobs</li>
          <li>Motor position and motor sensor</li>
