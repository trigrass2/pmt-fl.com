...
<head>
  <title>Linear Position Sensor - Magnetic Position Sensors | PMT</title>
  <meta name="description" content="The chip can measure magnetic field components in two different orientation directions and converts the magnetic field information into absolute position information. The AS5410 supports absolute linear position measurement applications.">
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">AS5410 Linear Position Sensor</h1>
        <h2 class="secondary-heading">14-bit linear absolut position sensor with digital (interface) and PWM output</h2>
        ...
        The AS5410 is an absolute position sensor for linear movements. To measure a long strocke (+/-25mm) with a large airgap (~10mm) a contactless magnetic sensor technology is used.To measure the absolute position of the motion a simple 2-pole magnet is required. The absolute information of the magnet position is measured with a 14-bit resolution and the digital value is provided via the serial interface (SPI) and PWM output signal.
          <img src="../../images/magnetic-position-sensors/AS5410-block-diagram_f380greyscale.jpg" alt="Block diagram of the AS5410 linear absolute position sensor"/>
        </p>
        ...
        <dl class="product-features">
          ...
          <dd>Absolute position sensing of linear strokes with large airgap</dd>
          ...
          <dd>Great flexibility for different applications</dd>
          <dd>Lower material cost (no magnetic shielding needed)</dd>
        </dl>

        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS5410 Product Facts</h2></th>
          </tr>
          <tr>
            <td>Resolution</td>
            <td>12-bit</td>
        ...
        <ul class="sub">
          <li>Pedal stroke measurement</li>
          <li>Plunger absolute position measurement</li>
          <li>Linear measurement tools</li>
        </ul>
