...
<head>
	...
	<title>PICOSTRAIN Gain &amp; Offset Drift | Precision Measurement Technologies</title>
...
<?php include("../includes/subnav-strain.php"); ?>
		...
		<div id="subBody">
			<div id="subTop">
				<h1 class="sub">PICOSTRAIN Gain &amp; Offset Drift</h1>
				<img class="main" src="/images/picostrain/ps021-main.jpg" alt="" />
				
				<p class="bold">Gain & Offset Drift over temperature</p>
				<p>Values in &micro;V, temperature range -20&deg;C to 90&deg;C</p>
			...
			<div id="subThird">
				<div id="sub3left">
					...
					<a href="/images/picostrain/ps021-gain-offset.jpg" rel="lightbox[picostrain]"><img src="/images/picostrain/ps021-gain-offset-thumb.jpg" alt="" /></a>
