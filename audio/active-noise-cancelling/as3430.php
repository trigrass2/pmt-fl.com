...
<head>
  <title>AS3430 Active Noise Cancellation - Audio | PMT</title>
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      ...
      <article class="product-details">
        <h1 class="primary-heading">AS3430 Active Noise Cancellation</h1>
        <h2 class="secondary-heading">Feedback ANC solution for accessories</h2>
        ...
        <p class="intro">
          ...
          <img src="../../images/audio/AS3430_Feed-Back-ANC-Block-Diagram_f380greyscale.jpg" alt="AS3430 Active Noise Cancellation Diagram"/>
        </p>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS3430 Product Facts</h2></th>
          </tr>
          <tr>
            <td>Function</td>
            <td>Receive path</td>
