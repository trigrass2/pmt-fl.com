...
<head>
  <title>AS2534 Feature Phone - Audio | Precision Measurement Tech</title>
    ...
    <section role="main" class="product-detail">
      ...
      <article class="product-details">
        ...
        <p class="intro">
          ...
          <img src="../../images/audio/AS2533-36-Diagram_f380greyscale.jpg" alt="AS2534 Single Chip Phone Circuit Block Diagram"/>
        </p>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS2534 Product Facts</h2></th>
          </tr>
          <tr>
