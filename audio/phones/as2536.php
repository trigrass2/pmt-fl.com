...
<head>
  <title>AS2536 Feature Phone - Audio | Precision Measurement Tech</title>
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      ...
      <article class="product-details">
        <h1 class="primary-heading">AS2536 Single Chip Phone</h1>
        ...
        <p class="intro">
          ...
          <img src="../../images/audio/AS2533-36-Diagram_f380greyscale.jpg" alt="AS2536 Single Chip Phone Circuit Block Diagram"/>
        </p>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS2536 Product Facts</h2></th>
          </tr>
          <tr>
