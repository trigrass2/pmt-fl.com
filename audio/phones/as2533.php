...
<head>
  <title>AS2533 Feature Phone - Audio | Precision Measurement Tech</title>
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      ...
      <article class="product-details">
        <h1 class="primary-heading">AS2533 Single Chip Phone</h1>
        <h2 class="secondary-heading">Single-chip telephone IC with line interface, speech circuit, dialler and ringer</h2>

        <p class="intro">
          The AS2533 is Single-chip Basic Phone integrated circuit and contains all functions needed to build a high performance electronic telephone set with basic features. The AS2533 incorporates a line interface, a speech circuit, a dialler and ringer, LNR (last number redial), 4 direct (one-touch) memories and 10 indirect (two-touch) memories.
          <img src="../../images/audio/AS2533-36-Diagram_f380greyscale.jpg" alt="AS2533 Single Chip Phone Circuit Block Diagram"/>
        </p>
        <a href="../../downloads/audio/AS2533-36_Datasheet_EN_v2.pdf"><button>Download Datasheet</button></a>
        <dl class="product-features">
          <dt>Key Features</dt>
          <dd>Line Interface and Speech circuit with electronic Rx volume control and microphone mute</dd>
          <dd>31 digit last number redial (LNR) and 4 direct/10 indirect memories</dd>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">AS2533 Product Facts</h2></th>
          </tr>
          <tr>
