...
<head>
	...
	<title>Advanced Time-to-Digital Converters, Measurement Systems Videos</title>

	<meta http-equiv="Content-type" content="text/html; charset=iso-8859-1" />
	<meta name="keywords" content="video, youtube, precision measurement technologies, pmt, time to digital tech" />
	<meta name="description" content="Videos on high resolution time-to-digital converters and measurement systems for time-of-flight (TOF), laser applications, and speed sensors." />	
...
<?php include("includes/subnav-gen.php"); ?>
		...
		<div id="subBody">
			<div id="subTop">
				<h1 class="sub">PMT Videos</h1>
				
				<p>You can view all of the videos by Precision Measurement Technologies here on this page, or feel free to directly visit our <a href="https://www.youtube.com/channel/UCHFXZiVJnvVAcFh0lEW4qPA" target="_blank" title="PMT Video Channel">YouTube channel</a> directly.</p>
			...
			<iframe width="560" height="315" src="https://www.youtube.com/embed/Huxdunu4Q5k" frameborder="0" allowfullscreen></iframe>
			...
			<iframe width="560" height="315" src="https://www.youtube.com/embed/D00Or2tF1EI" frameborder="0" allowfullscreen></iframe>
