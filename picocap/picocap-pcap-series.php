...
<head>
	...
	<title>PICOCAP PCap Series | Precision Measurement Technologies</title>
...
<?php include("../includes/subnav-cap.php"); ?>
		...
		<div id="subBody">
			<div id="subTop">
				<h1 class="sub">PICOCAP PCap Series</h1>
				<img class="main" src="/images/picocap/picocap-main.jpg" alt="" />

				<p>PCap01 has been the first chip of the PICOCAP ® product line and was introduced to the market in early 2010. Now, in early 2013 mass production samples of the successor PCap02 have been released (full mass production planned in Q2/2013) with a particular focus on humidity applications. Also in early 2013 engineering samples of PCap03 for highest performance applications will be available. </p>
