...
<head>
  <title>HLS-440P A Hydrogen Sensor - Chemical Sensors | PMT</title>
  ...
  <div id="containerIn">
    ...
    <section role="main" class="product-detail">
      <article class="product-details">
        <h1 class="primary-heading">HLS-440P A Hydrogen Sensor</h1>
        <h2 class="secondary-heading">Hydrogen leak sensor, 0-10% H2, CAN interface, baud rate 500k, with termination resistor</h2>
        ...
        <table class="product-facts">
          <tr>
            <th colspan="2"><h2 class="sub">HLS-440P A Product Facts</h2></th>
          </tr>
          <tr>
            <td>Interface</td>
          ...
          <tr>
            ...
            <td>0 to 10% H2 resolution 500ppm</td>
          </tr>
          <tr>
            <td>Accuracy</td>
            <td>5000ppm</td>
