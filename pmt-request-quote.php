...
if(isset($_POST['submit'])) {
	...
	if(!isset($hasError)) {
		...
		$body = "Name: $name \n\nEmail: $email \n\nSubject: $subject \n\nComments:\n $comments";
		$headers = 'From: PMT Web Quote <'.$emailTo.'>' . "\r\n" . 'Reply-To: ' . $email;
		...
		//DB Bit
			...
			$sql = "INSERT INTO user_form_info ".
				   "(user_name,user_company,user_phone,user_email,user_subject,user_msg,submit_date,info_type) ".
				   "VALUES ".
				   "('$name','$company','$phone','$email','$subject','$esccomments','$submit_date','$infotyp')";
			mysql_select_db( 'precitb3_pmtuserinfo' );
...
<head>
	...
	<title>Request a Quote | Precision Measurement Technologies</title>
...
<?php include("includes/subnav-gen.php"); ?>
		...
		<div id="subBody">
			<div id="subTop">
				<h1 class="sub">Request a Quote</h1>
			...
			<div id="subSecond">
				...
				<h2 class="sub">Request a Quote from PMT</h2>
				<div class="wrapper">
				<div id="contactWrapper" role="form">
					...
					<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="contactform">
						...
						<div class="stage clear">
							<label for="subject"><strong>Product: <em>*</em></strong></label>
